...
pragma solidity ^0.4.24;
 ...
 /**
 * Token Smart contract for EXC token 
 * Token Name: Exchange
 * Token Symbol: EXC
 * Initial Total Supply : 1000000000000
 * Standard: ERC20
 */
...
interface IERC20 {
 ...
 /**
 * @title Exchange Contract For ERC20 Tokens
 * @dev EXC tokens as per ERC20 Standards
 */
 contract EXC is IERC20 {
    ...
    uint256 private _tokenPriceETH;                 // variable to set price of token with respect to ETH.
  ...
  */
  ...
  // function to get price of each token for ETH purchase
